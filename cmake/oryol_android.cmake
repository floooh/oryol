...
macro(oryol_android_postbuildstep target)
    ...
    add_custom_command(TARGET ${target} POST_BUILD COMMAND ${CMAKE_COMMAND} -E make_directory ${ORYOL_ROOT_DIR}/bin/android COMMAND ${CMAKE_COMMAND} -E copy ${CMAKE_CURRENT_BINARY_DIR}/android/bin/${target}-debug.apk ${ORYOL_ROOT_DIR}/bin/android/)
endmacro()