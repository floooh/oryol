...
set(CMAKE_CXX_FLAGS_PROFILING "-Oz -profiling")
...
set(CMAKE_C_FLAGS_PROFILING "-Oz -profiling")
...
set(CMAKE_EXE_LINKER_FLAGS_PROFILING "-profiling -Oz --llvm-lto ${EMSCRIPTEN_LTO_LEVEL} -s VERBOSE=${EMSCRIPTEN_BUILD_VERBOSE} -s ASM_JS=1 -s ASSERTIONS=${EMSCRIPTEN_ASSERTIONS} -s OUTLINING_LIMIT=${EMSCRIPTEN_OUTLINING_LIMIT}")
...
set(CMAKE_SHARED_LINKER_FLAGS_PROFILING "-profiling -Oz --llvm-lto ${EMSCRIPTEN_LTO_LEVEL} -s VERBOSE=${EMSCRIPTEN_BUILD_VERBOSE} -s ASM_JS=1 -s ASSERTIONS=${EMSCRIPTEN_ASSERTIONS} -s OUTLINING_LIMIT=${EMSCRIPTEN_OUTLINING_LIMIT}")
