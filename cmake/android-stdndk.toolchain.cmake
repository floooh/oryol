...
set(ANDROID_SDK_ROOT "${CMAKE_CURRENT_LIST_DIR}/../sdks/osx/android-sdk-macos")
set(ANDROID_SDK_TOOL "${ANDROID_SDK_ROOT}/tools/android")
set(ANDROID_NDK_HOST "darwin-x86_64")
set(ANDROID_NDK_ARCH "armv7")
...
set(ANDROID_NDK_GLOBAL_CFLAGS "-fPIC -fomit-frame-pointer -fno-strict-aliasing -ffunction-sections -funwind-tables -fstack-protector -no-canonical-prefixes")
...
# standard libraries
set(CMAKE_CXX_STANDARD_LIBRARIES "-nostdlib -landroid -llog -lc -lm -lgcc")
set(CMAKE_C_STANDARD_LIBRARIES "-nostdlib -landroid -llog -lc -lm -lgcc")
...
set(ANDROID_LD_FLAGS "-shared --sysroot=${ANDROID_NDK_SYSROOT} -L${ANDROID_NDK_STL_LIBRARYPATH} ${ANDROID_NDK_STL_LDFLAGS} -no-canonical-prefixes -Wl,--fix-cortex-a8 -Wl,--no-warn-mismatch -Wl,--no-undefined -Wl,-z,noexecstack -Wl,-z,relro -Wl,-z,now ${ORYOL_ANDROID_LINK_VERBOSE}")
