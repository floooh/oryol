...
TEST(RenderTargetCreationTest) {
    ...
    CHECK(attrs0.GetType() == TextureType::Texture2D);
    CHECK(attrs0.GetColorFormat() == PixelFormat::R8G8B8A8);
    CHECK(attrs0.GetDepthFormat() == PixelFormat::InvalidPixelFormat);
    CHECK(attrs0.GetUsage() == Usage::Immutable);
    CHECK(attrs0.GetWidth() == 320);
    CHECK(attrs0.GetHeight() == 256);
    CHECK(attrs0.GetDepth() == 0);
    ...
    CHECK(attrs1.GetType() == TextureType::Texture2D);
    CHECK(attrs1.GetColorFormat() == PixelFormat::R8G8B8A8);
    CHECK(attrs1.GetDepthFormat() == PixelFormat::D24S8);
    CHECK(attrs1.GetUsage() == Usage::Immutable);
    CHECK(attrs1.GetWidth() == 640);
    CHECK(attrs1.GetHeight() == 480);
    CHECK(attrs1.GetDepth() == 0);
    ...
    CHECK(attrs2.GetType() == TextureType::Texture2D);
    CHECK(attrs2.GetColorFormat() == PixelFormat::R5G6B5);
    CHECK(attrs2.GetDepthFormat() == PixelFormat::D16);
    CHECK(attrs2.GetUsage() == Usage::Immutable);
    CHECK(attrs2.GetWidth() == 400);
    CHECK(attrs2.GetHeight() == 300);
    CHECK(attrs2.GetDepth() == 0);
