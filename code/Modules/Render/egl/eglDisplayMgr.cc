...
eglDisplayMgr::SetupDisplay(const RenderSetup& renderSetup) {
    ...
    EGLint eglConfigAttrs[] = {
        ...
        EGL_RED_SIZE, PixelFormat::NumBits(renderSetup.ColorFormat, PixelChannel::Red),
        EGL_GREEN_SIZE, PixelFormat::NumBits(renderSetup.ColorFormat, PixelChannel::Green),
        EGL_BLUE_SIZE, PixelFormat::NumBits(renderSetup.ColorFormat, PixelChannel::Blue),
        EGL_ALPHA_SIZE, PixelFormat::NumBits(renderSetup.ColorFormat, PixelChannel::Alpha),
        EGL_DEPTH_SIZE, PixelFormat::NumBits(renderSetup.DepthFormat, PixelChannel::Depth),
        EGL_STENCIL_SIZE, PixelFormat::NumBits(renderSetup.DepthFormat, PixelChannel::Stencil),
        EGL_NONE
    };
    EGLint numConfigs = 0;
