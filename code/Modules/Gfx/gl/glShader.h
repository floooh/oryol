...
public:
    ...
    void bindSampler(ShaderStage::Code bindStage, int32 bindSlot, int32 textureIndex, int32 samplerIndex);
    ...
    int32 getSamplerIndex(ShaderStage::Code bindStage, int32 bindSlot, int32 textureIndex) const;
    #if ORYOL_GL_USE_GETATTRIBLOCATION
    ...
    static int32 samplerArrayIndex(ShaderStage::Code bindStage, int32 bindSlot, int32 textureIndex);
...
//------------------------------------------------------------------------------
inline int32
glShader::samplerArrayIndex(ShaderStage::Code bindStage, int32 bindSlot, int32 textureIndex) {
    return textureIndex + bindSlot*MaxTexturesPerBlock + bindStage*MaxTBsPerStage*MaxTexturesPerBlock;
}
...
//------------------------------------------------------------------------------
inline int32
glShader::getSamplerIndex(ShaderStage::Code bindStage, int32 bindSlot, int32 textureIndex) const {
    return this->samplerMappings[samplerArrayIndex(bindStage, bindSlot, textureIndex)];
}
