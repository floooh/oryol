...
function integrateWasmJS(Module) {
 ...
 var wasmTextFile = Module["wasmTextFile"] || "InfiniteSpheres.wast";
 var wasmBinaryFile = Module["wasmBinaryFile"] || "InfiniteSpheres.wasm";
 var asmjsCodeFile = Module["asmjsCodeFile"] || "InfiniteSpheres.temp.asm.js";
...
__ATINIT__.push();
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "InfiniteSpheres.html.mem" : null;
