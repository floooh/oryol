...
function integrateWasmJS(Module) {
 ...
 var wasmTextFile = Module["wasmTextFile"] || "NativeTexture.wast";
 var wasmBinaryFile = Module["wasmBinaryFile"] || "NativeTexture.wasm";
 var asmjsCodeFile = Module["asmjsCodeFile"] || "NativeTexture.temp.asm.js";
...
var ASM_CONSTS = [];
STATIC_BASE = 1024;
STATICTOP = STATIC_BASE + 12096;
__ATINIT__.push();
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "NativeTexture.html.mem" : null;
var STATIC_BUMP = 12096;
