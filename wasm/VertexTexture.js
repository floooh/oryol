...
function integrateWasmJS(Module) {
 ...
 var wasmTextFile = Module["wasmTextFile"] || "VertexTexture.wast";
 var wasmBinaryFile = Module["wasmBinaryFile"] || "VertexTexture.wasm";
 var asmjsCodeFile = Module["asmjsCodeFile"] || "VertexTexture.temp.asm.js";
...
__ATINIT__.push();
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "VertexTexture.html.mem" : null;
var STATIC_BUMP = 32240;
