...
function integrateWasmJS(Module) {
 ...
 var wasmTextFile = Module["wasmTextFile"] || "Julia.wast";
 var wasmBinaryFile = Module["wasmBinaryFile"] || "Julia.wasm";
 var asmjsCodeFile = Module["asmjsCodeFile"] || "Julia.temp.asm.js";
...
var ASM_CONSTS = [];
STATIC_BASE = 1024;
STATICTOP = STATIC_BASE + 21472;
__ATINIT__.push();
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "Julia.html.mem" : null;
var STATIC_BUMP = 21472;
