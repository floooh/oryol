...
function integrateWasmJS(Module) {
 ...
 var wasmTextFile = Module["wasmTextFile"] || "SimpleRenderTarget.wast";
 var wasmBinaryFile = Module["wasmBinaryFile"] || "SimpleRenderTarget.wasm";
 var asmjsCodeFile = Module["asmjsCodeFile"] || "SimpleRenderTarget.temp.asm.js";
...
__ATINIT__.push();
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "SimpleRenderTarget.html.mem" : null;
var STATIC_BUMP = 15664;
