...
function integrateWasmJS(Module) {
 ...
 var wasmTextFile = Module["wasmTextFile"] || "Instancing.wast";
 var wasmBinaryFile = Module["wasmBinaryFile"] || "Instancing.wasm";
 var asmjsCodeFile = Module["asmjsCodeFile"] || "Instancing.temp.asm.js";
...
var ASM_CONSTS = [];
STATIC_BASE = 1024;
STATICTOP = STATIC_BASE + 24096;
__ATINIT__.push();
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "Instancing.html.mem" : null;
var STATIC_BUMP = 24096;
