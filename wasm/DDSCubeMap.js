...
function integrateWasmJS(Module) {
 ...
 var wasmTextFile = Module["wasmTextFile"] || "DDSCubeMap.wast";
 var wasmBinaryFile = Module["wasmBinaryFile"] || "DDSCubeMap.wasm";
 var asmjsCodeFile = Module["asmjsCodeFile"] || "DDSCubeMap.temp.asm.js";
...
var ASM_CONSTS = [];
STATIC_BASE = 1024;
STATICTOP = STATIC_BASE + 13456;
__ATINIT__.push();
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "DDSCubeMap.html.mem" : null;
var STATIC_BUMP = 13456;
