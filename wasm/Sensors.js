...
function integrateWasmJS(Module) {
 ...
 var wasmTextFile = Module["wasmTextFile"] || "Sensors.wast";
 var wasmBinaryFile = Module["wasmBinaryFile"] || "Sensors.wasm";
 var asmjsCodeFile = Module["asmjsCodeFile"] || "Sensors.temp.asm.js";
...
__ATINIT__.push();
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "Sensors.html.mem" : null;
