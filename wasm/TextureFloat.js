...
function integrateWasmJS(Module) {
 ...
 var wasmTextFile = Module["wasmTextFile"] || "TextureFloat.wast";
 var wasmBinaryFile = Module["wasmBinaryFile"] || "TextureFloat.wasm";
 var asmjsCodeFile = Module["asmjsCodeFile"] || "TextureFloat.temp.asm.js";
...
var ASM_CONSTS = [];
STATIC_BASE = 1024;
STATICTOP = STATIC_BASE + 28912;
__ATINIT__.push();
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "TextureFloat.html.mem" : null;
var STATIC_BUMP = 28912;
